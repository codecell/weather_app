...
/***/ "./src/components/displayForecast.js":
/*!*******************************************!*\
  !*** ./src/components/displayForecast.js ***!
  \*******************************************/
/*! namespace exports */
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\nconst displayForecast = (city, temp, icon, description, humidity, date) => {\n  const weatherCard = document.querySelector('#weatherCard');\n\n  weatherCard.innerHTML = `\n      <h2 id=\"cityName\" class=\"city-name\">${city}</h2>\n      <h4>${date}</h4>\n      <h2>${temp}</h2>\n      <img src=\"${icon}\" class=\"weather-icon\"></img>\n      <h2>Description: ${description}</h2>\n      <h2>Humidity: ${humidity} %</h2>    \n    `;\n  return weatherCard;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (displayForecast);\n\n//# sourceURL=webpack://weather_app/./src/components/displayForecast.js?");

/***/ }),

/***/ "./src/components/queryWeather.js":
/*!****************************************!*\
  !*** ./src/components/queryWeather.js ***!
  \****************************************/
/*! namespace exports */
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _css_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/style.css */ \"./css/style.css\");\n/* harmony import */ var _components_queryWeather__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/queryWeather */ \"./src/components/queryWeather.js\");\n\n\n\n(0,_components_queryWeather__WEBPACK_IMPORTED_MODULE_1__.default)('Lagos');\n\nconst forecastBtns = document.querySelectorAll('.btn');\n\nforecastBtns.forEach((btn, idx) => {\n  btn.addEventListener('click', (e) => {\n    e.preventDefault();\n\n    const city = document.querySelector('#city');\n\n    if (city.value === '') {\n      (0,_components_queryWeather__WEBPACK_IMPORTED_MODULE_1__.default)('Lagos', idx);\n    }\n\n    (0,_components_queryWeather__WEBPACK_IMPORTED_MODULE_1__.default)(city.value, idx);\n    city.value = '';\n  });\n});\n\n\n//# sourceURL=webpack://weather_app/./src/index.js?");
